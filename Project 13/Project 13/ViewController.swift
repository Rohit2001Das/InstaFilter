...
//  Project 13
//
//  Created by ROHIT DAS on 16/10/22.
//
import CoreImage
import UIKit
...
class ViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    @IBOutlet weak var changeFilterlabel: UIButton!
    ...
    @IBAction func save(_ sender: Any) {
        ...
        if currentImage == nil{
            let ac = UIAlertController(title: "There is no image", message: "Select an image from the picker", preferredStyle: .alert)
